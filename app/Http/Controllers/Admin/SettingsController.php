    	...
    	$email=Session::get('bamaAdmin');
    	 $admin= DB::table('admins')
    	  ...
    	  $logo = DB::table('tbl_web_setting')
                ->first();
         return view('admin.settings.app_details',compact("email","admin",'title','logo'));
    ...
    public function updateappdetails(Request $request)
    {
        ...
        $oldfavicon = $check->favicon;
         ...
         if($request->hasFile('app_icon')){
            ...
            $app->move(storage_path('app/public/images/app_logo/').$date.'/', $fileName);
            $app = 'storage/images/app_logo/'.$date.'/'.$fileName;
        }
        else{
            $app = $oldapplogo;
        }
        if($check->favicon != NULL){
         ...
         if($request->hasFile('favicon')){
            ...
            $fileName = str_replace(" ", "-", $fileName);
            $favicon->move(storage_path('app/public/images/app_logo/favicon/').$date.'/', $fileName);
            $favicon = 'storage/images/app_logo/favicon/'.$date.'/'.$fileName;
        }
        else{
            $favicon = $oldfavicon;
        }
    	 ...
    	 $admin= DB::table('admins')
          ...
          $twilio = DB::table('twilio')
            ...
            $smsby = DB::table('smsby')
                ->first();
         return view('admin.settings.msg91',compact("email","admin",'title','logo','msg91','twilio','smsby'));
    	 ...
    	 $admin= DB::table('admins')
    	  ...
    	  $logo = DB::table('tbl_web_setting')
            ...
            $map = DB::table('map_API')
                ->first();
         return view('admin.settings.map_api',compact("email","admin",'title','logo','map'));
    	...
    	$email=Session::get('bamaAdmin');
    	 $admin= DB::table('admins')
    	  ...
    	  $logo = DB::table('tbl_web_setting')
            ...
            $fcm = DB::table('fcm')
                ->first();
         return view('admin.settings.fcm',compact("email","admin",'title','logo','fcm'));
    	 ...
    	 $admin= DB::table('admins')
    	  ...
    	  $logo = DB::table('tbl_web_setting')
            ...
            $del_charge = DB::table('freedeliverycart')
                ->first();
         return view('admin.settings.del_charge',compact("email","admin",'title','logo','del_charge'));
    	 ...
    	 $admin= DB::table('admins')
    	  ...
    	  $logo = DB::table('tbl_web_setting')
            ...
            $currency = DB::table('currency')
                ->first();
         return view('admin.settings.currency',compact("email","admin",'title','logo','currency'));
    	 ...
    	 $admin= DB::table('admins')
    	  ...
    	  $logo = DB::table('tbl_web_setting')
            ...
            $prv = DB::table('payout_req_valid')
                ->first();
         return view('admin.settings.payoutreq_validation',compact("email","admin",'title','logo','prv'));
