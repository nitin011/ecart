 ...
 public function nextdayorders(Request $request)
     {
      ...
      foreach($ord as $ords){
        ...
        $data[]=array('user_address'=>$ords->house_or_flat_no.','.$ords->society.','.$ords->city.','.$ords->landmark.','.$ords->state.','.$ords->pincode, 'cart_id'=>$cart_id,'user_name'=>$ords->user_name, 'user_phone'=>$ords->user_phone,
