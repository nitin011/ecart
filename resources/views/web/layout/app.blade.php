...
<script>
    var currency= '{{ $currency->currency_sign }}';
    function getVals(){
        // Get slider values
        ...
        displayElement.innerHTML = currency + slide1 + "k - "+currency + slide2 + "k";*/
        document.getElementById('min_price').value = currency + slide1;
        document.getElementById('max_price').value= currency + slide2;
        document.querySelector('input[name="filter[min_price]"]').value= slide1;
        document.querySelector('input[name="filter[max_price]"]').value= slide2;
    }
