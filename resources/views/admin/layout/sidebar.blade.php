    ...
    <div class="sidebar-wrapper">
        ...
        <!--<li class="nav-item">
          ...
          <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link" data-toggle="collapse" href="#cat-dropdown" aria-expanded="false"
        ...
        <!--<li class="nav-item ">
            ...
            <li class="nav-item">
                <a class="nav-link" data-toggle="collapse" href="#city-dropdown" aria-expanded="false"
                   aria-controls="setting-dropdown">
            ...
            {{--<li class="nav-item">
                <a class="nav-link" data-toggle="collapse" href="#store-dropdown" aria-expanded="false"
                   aria-controls="setting-dropdown">
            ...
            <li class="nav-item">
                <a class="nav-link" data-toggle="collapse" href="#ord-dropdown" aria-expanded="false"
                   aria-controls="setting-dropdown">
            ...
            {{--<li class="nav-item">
                <a class="nav-link" data-toggle="collapse" href="#payout-dropdown3" aria-expanded="false"
                   aria-controls="setting-dropdown2">
            ...
            {{--<li class="nav-item">
                <a class="nav-link" data-toggle="collapse" href="#setting-dropdown3" aria-expanded="false"
                   aria-controls="setting-dropdown2">
        ...
        <!-- <li class="nav-item">
          ...
          <li class="nav-item ">
            ...
            <li class="nav-item ">
                <a class="nav-link" href="{{ route('database-settings.index') }}">
