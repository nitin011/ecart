        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="forms-sample" action="{{ route('banneradd') }}" method="post"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="bmd-label-floating">Slider Type</label>
                                        {{ Form::select('type',\App\Models\Banner::BANNER_TYPES,null,['class'=>'custom-select']) }}
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="bmd-label-floating">Sort Description</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="button_route" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
