...
@media print {
    ...
    <body>
        <div class="ticket" align="center">
            <img src="{{ assetUrl('images/default/logo.jpg') }}" alt="app-logo" style="width:40px"/>
            <p class="centered">ADDRESS-
            <p> <b>Name</b> : {{$order->user_name}}<br>
            <b>Address</b> : {{$order->house_or_flat_no}},{{$order->society}},{{$order->landmark}},{{$order->city}},{{$order->state}},{{$order->pincode}}</br>
