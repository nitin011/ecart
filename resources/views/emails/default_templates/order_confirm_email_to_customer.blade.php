...
<div
    ...
    Your recent order placed successfuly.
</div>
                ...
                <tr>
                    <td align="center" valign="top" style="padding: 40px 10px 40px 10px;">
                        <a href="#" target="_blank"><font color="#efefef"><b>
                            ...
                            <h3><font color="#efefef"><b>ee</b></font></h3>
                        </a>
                    </td>
                </tr>
                </tbody>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="480">
                ...
                <tr>
                    <td bgcolor="#ffffff" align="center" valign="top"
                        ...
                        <h1 style="font-size: 32px; font-weight: 400; margin: 0;">Order Confirmation</h1>
                    </td>
                </tr>
                </tbody>
            </table>
                ...
                <tr>
                    <td bgcolor="#ffffff" align="left"
                        ...
                        <p style="margin: 0;">Hey #NAME#, <br>
                            ...
                            We'll drop your another email when your order ships.<br>
                        </p>
                        <dl class="row">
                            <dt><br></dt>
                        </dl>
                                    ...
                                    <table border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr>
                                            <td align="center" style="border-radius: 3px;" bgcolor="#7c72dc"><a
                                                    href="#ORDERS_LIST_LINK#" target="_blank"
                ...
                <tr>
                    <td bgcolor="#f4f4f4" align="left"
                        ...
                        <p style="margin: 0;">You received this email because you requested a password reset. If you did
                            not, <a href="http://ee.com" target="_blank"
