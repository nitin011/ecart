            ...
            <div class="row justify-content-center">
                <div class="col-lg-7 col-md-8">
                    <div class="order-placed-dt">
                        ...
                        <p>Thank you for your order! will received order timing - <span>(Today, 3.00PM - 5.00PM)</span>
                        </p>
                            ...
                            <ul class="address-placed-dt1">
                                <li>
                                    <p>
                                        ...
                                        Address :
                                        <span>#000, St 8, Sks Nagar, Near Pakhowal Road, Ldh, 141001</span>
                                    </p>
                                </li>
                                <li>
                                    <p>
