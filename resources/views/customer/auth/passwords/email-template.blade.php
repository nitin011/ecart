                            ...
                            <tr>
                                <td class="content-cell"
                                    ...
                                    <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787E; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                        ...
                                        your account. Click the button below to reset your password:</p>
                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0"
                                                                ...
                                                                <tr>
                                                                    <td style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box;">
                                                                        <a href="{{ route('customer.reset-password',$token) }}"
                                    ...
                                    @if(isset($otp))
                                        <h4 style="text-align: center; margin: auto;">OTP: <strong>{{ $otp }}</strong></h4>
                                    @endif
                                    <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787E; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                        If you did not request a password reset, no further action is required.</p>
                                    <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787E; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                        Regards,<br>{{ env('APP_NAME') }}</p>
                                            ...
                                            <td style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box;">
                                                <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787E; line-height: 1.5em; margin-top: 0; text-align: left; font-size: 12px;">
                                                    ...
                                                    into your web browser: <a
                                                        href="{{ route('customer.reset-password',$token) }}"
