...
Currency</span>
    ...
    <nav class="navbar navbar-expand-sm navbar-light bg-white" style="margin-top: -16px;">
        <a class="navbar-brand" href="index.php" style="margin-top: -6px;height: 30px;"><img
                src="{{url('webstyle/image/logo.PNG') }}" style="margin-top: -10px;margin-left: 12px;"></a>
                ...
                <ul class="navbar-nav mr-auto mt-2 mt-lg-0" style="color: black">
                    ...
                    <li class="nav-item mobile_menu02" style="margin-right:16px;">
                        ...
                        <div class="dropdown" style="height: 32px;">
                            <p style="margin-top: -5px;">Welcome {{$cust->user_name ?? null}} &nbsp; <img
                                    src="{{url('webstyle/image/panga.PNG') }}" height="35" style="border-radius: 10px;">
                            </p>
                    ...
                    @if(Session::has('bamaCust'))
                        <li class="nav-item header_li_7 mobile_menu03" onclick="openNav()">
                            <a class="nav-link" href="#" style="color: black;margin-top: -3px;"><img
                                    src="{{url('webstyle/image/cart.PNG') }}" height="28" style="margin-top: -7px;">
                                <span class="cart_num">7</span></a>
                        </li>
                    @endif
...
<div id="mySidepanel" class="sidepanel shadow-lg">
    ...
    <h5 class="sidenav_h5">My Cart <span class="sidenav_span" onclick="closeNav()"><i class="fas fa-times"
        ...
        <div class="row" style="padding: 15px 10px 5px 10px;">
            ...
            <div class="col-sm-3">
                <div class="btn-group btn-group-sm but_div3" role="group" aria-label="...">
                    ...
                    <button class="but_one3"><input type="number" style="border: 0;width: 29px;outline: none;" value="1"
                                                    name=""></button>
    ...
    <div class="card header_card12">
        <div class="card-body">
            ...
            <a href="cart.php" style="width: 45%;display: inline-block;">
